...
<Library LVVersion="20008000">
	...
	<Item Name="poly_members" Type="Folder">
		<Item Name="Filter Error Codes (Array).vi" Type="VI" URL="../Filter Error Codes/Filter Error Codes (Array).vi"/>
		<Item Name="Filter Error Codes (Scalar).vi" Type="VI" URL="../Filter Error Codes/Filter Error Codes (Scalar).vi"/>
	</Item>
	<Item Name="typedefs" Type="Folder">
		<Item Name="Filtered Error Details - Cluster.ctl" Type="VI" URL="../Filter Error Codes/Filtered Error Details - Cluster.ctl"/>
	</Item>
	<Item Name="Build Error Cluster.vi" Type="VI" URL="../Build Error Cluster.vi"/>
	<Item Name="Case (Error IO).vi" Type="VI" URL="../Case (Error IO).vi"/>
	<Item Name="Clear All Errors.vi" Type="VI" URL="../Clear All Errors.vi"/>
	<Item Name="Error Codes Ring Constant.vi" Type="VI" URL="../Error Codes Ring Constant.vi"/>
	<Item Name="Error Constant.vi" Type="VI" URL="../Error Constant.vi"/>
	<Item Name="Filter Error Codes.vi" Type="VI" URL="../Filter Error Codes.vi"/>
</Library>
